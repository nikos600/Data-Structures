...
#include <stdlib.h>
    ...
    First *Concatenation(First *l,First *l1) {   /*in this function i get my 2 lists from main*/
        Sorted(l);         /*i sort them*/      /*that's my main function for quest 7 of my first assignment*/
        Sorted(l1);
        Nodetype *N1,*P2,*M3,*node;  
        P2 = l1->headlist;    /*2 nodetype pointers for each list to handle them easier*/
        N1 = l->headlist;
        ...
        First *l3 = (First*)malloc(sizeof(First));
            ...
            while (N1 && P2) {     /*here compare l and l1 list and put the numbers in ascending order while are not NULL*/
                ...
                else {       /*and with M3 point to node which is the new insertion number*/
                    M3->link = node;
                    M3 = node;
                }
            }
    ...
    void Sorted(First *h) {
        ...
        Nodetype *GetPrev(First *h,Nodetype *N) {  
            Nodetype *P = h->headlist;  /*here i get the previous number from node N to compare with it*/
            if (P == N) {   /*in the sort function*/
                return NULL;
            }
        ...
        int main(void) {
            ...
            Sorted(&l1);
            Print(&l1);
            l2 = Concatenation(&l,&l1);   /*main function Concatenation for quest 7 */
            Print(l2);                    /*that it takes the 2 lists as arguments and so on*/
            return 0;
        }